# -*- coding: utf-8 -*-
"""
Created on Sun Apr 26 14:53:38 2020
...
def get_filters():
    ...
    month = input('Would you like to filter the data by month? Which one? (Type january...june or all)\n').lower()
    while month not in ['january', 'february', 'march', 'april', 'may', 'june','all']:
        month = input('Try again... (Type january...june or all)\n').lower()


    # TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
    day = input('Would you like to filter the data by day? Which one? (Type Sunday, Monday..."or "all)\n').capitalize()
    while day not in ['Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','All']:
        day = input('Try again... (Type Sunday, Monday..."or "all)\n').capitalize()
